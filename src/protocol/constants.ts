...
export const PROFILES: Record<string, LOTPProfile> = {
  reliable: {
    id: 'reliable',
    name: 'Reliable QR',
    description: 'Small QR frames at 5 FPS. Best for low-end cameras or long distance.',
    gridRows: 24,
    gridCols: 24,
    ...
    rsEccBytes: 4,
    tilesCount: 1,
    fountainBlockSize: 16,
    manifestIntervalMs: 1500,
  },
  balanced: {
    id: 'balanced',
    name: 'Balanced QR',
    description: 'Medium QR frames at 7 FPS. Recommended for most phones.',
    gridRows: 24,
    gridCols: 24,
